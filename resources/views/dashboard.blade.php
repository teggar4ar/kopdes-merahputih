                            ...
                            @if($loanSummary['has_active_loan'])
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="font-semibold">{{ $loanSummary['formatted_principal'] }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="font-semibold">{{ $loanSummary['formatted_monthly_payment'] }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600">Cicilan Ke:</span>
                                        <span class="font-semibold">{{ $loanSummary['next_installment_number'] }} dari {{ $loanSummary['total_installments'] }}</span>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <div class="flex justify-between text-sm text-gray-600 mb-1">
                                            ...
                                            <span>{{ $loanSummary['progress_percentage'] }}%</span>
                                        </div>
                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                            <div class="bg-green-600 h-2 rounded-full" style="width: {{ $loanSummary['progress_percentage'] }}%"></div>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="text-center py-8">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Anda dapat mengajukan pinjaman baru kapan saja.</p>
                                </div>
                            @endif
                        </div>
