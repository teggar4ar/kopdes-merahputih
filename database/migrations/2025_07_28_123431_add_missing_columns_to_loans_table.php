...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('loans', function (Blueprint $table) {
            $table->decimal('monthly_installment', 15, 2)->default(0)->after('duration_months');
    ...
    {
        Schema::table('loans', function (Blueprint $table) {
            $table->dropColumn(['monthly_installment', 'approval_notes', 'first_installment_date', 'total_paid', 'remaining_balance']);
        });
    }
};
